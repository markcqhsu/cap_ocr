...
LEFT_TEMPLATE = [
    ...
    ("注塑設定", "T120",  "保壓總終期間",   "±0.5", "s"),
    ("注塑設定", "T2",    "射出時間",       "±0.5", "s"),
    ("注塑設定", "P21",   "背壓",           "±10",  "bar"),
    ("注塑設定", "N21",   "螺桿轉速",       "±10",  "1/min"),
    ("注塑設定", "P12",   "切換液壓系統壓力","±50", "bar"),
    ("開針",    "TS-1",  "開針打開延遲",   "±0.5", "s"),
    ("開針",    "T6.1",  "開針關閉延遲",   "±0.5", "s"),
    ("開針",    "S1",    "注口",           "±10",  "%"),
    ("脫模",    "F111",  "生產週期時間",   "±2",   "s"),
    ("脫模",    "T71",   "頂出停留時間",   "±2",   "s"),
    ("冰水",    "",      "溫度",           "±5",   "℃"),
...
RIGHT_TEMPLATE = [
    ("機器加熱設定", "77",  "塑料段1區溫度",     "±10", "℃"),
    ("機器加熱設定", "76",  "加熱段1區溫度",     "±10", "℃"),
    ("機器加熱設定", "75",  "加熱段2區溫度",     "±10", "℃"),
    ("機器加熱設定", "74",  "加熱段3區溫度",     "±10", "℃"),
    ("機器加熱設定", "73",  "加熱段4區溫度",     "±10", "℃"),
    ("機器加熱設定", "72",  "塑化閥圓段溫度",    "±10", "℃"),
    ...
    ("機器加熱設定", "51",  "射出頭溫度",        "±10", "℃"),
    ("模具加熱設定", "401", "進口1區溫度",       "±10", "℃"),
    ("模具加熱設定", "402", "進口2區溫度",       "±10", "℃"),
    ("模具加熱設定", "403", "主澆道基礎溫度",    "±10", "℃"),
